  ...
  render() {
    return (
      <li className={this.getClassName()}>
        <div className="view">
          <Can do={PermissionEnums.TODO_UPDATE} on={this.props.todo} ref={this.mayUpdateTodo}>
          ...
          <Can do={PermissionEnums.TODO_DELETE} on={this.props.todo}>
            <button className="destroy" onClick={this.removeTodo.bind(this)}></button>
          </Can>
        </div>
        <Can do={PermissionEnums.TODO_UPDATE} on={this.props.todo}>
